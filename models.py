...
def create_model(fingerprint_input, model_settings, model_architecture,
  ...
  if model_architecture == 'single_fc':
    return create_single_fc_model(fingerprint_input, model_settings,
                                  is_training)
  elif model_architecture == 'kaggle':
    return create_kaggle_model(fingerprint_input, model_settings, is_training)
...
def build_rnn_cell(hidden_units_per_recurrent_layer, recurrent_layers_count=2):
  rnn_layers = [tf.nn.rnn_cell.GRUCell(hidden_units_per_recurrent_layer)] * recurrent_layers_count
