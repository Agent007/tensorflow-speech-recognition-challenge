...
python train.py --data_url '' --data_dir data/train/audio --background_volume 0.75 --silence_percentage 8.333333333 --unknown_percentage 8.333333333 --testing_percentage 0 --validation_percentage 1 --how_many_training_steps 1200,400,400  --eval_step_interval ${EVAL_STEP_INTERVAL} --learning_rate 0.001,0.0003,0.0001 --batch_size ${BATCH_SIZE} --summaries_dir data/retrain_logs --train_dir data/speech_commands_train --model_architecture kaggle
